...
def test_home_assistant_list_states_blocks_metadata_without_request():
    ...
    with (
        ssrf_enabled(),
        patch("lfx.components.homeassistant.list_home_assistant_states.requests.get") as mock_get,
    ):
...
def test_home_assistant_control_blocks_metadata_without_request():
    ...
    with (
        ssrf_enabled(),
        patch("lfx.components.homeassistant.home_assistant_control.requests.post") as mock_post,
    ):
